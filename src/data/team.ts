export interface Founder { name: string; role: string; initials: string; photo?: string; bio: string; short: string }
...
export const team: Founder[] = [
  {
    ...
    short: 'Co-Founder of Deepvine AI. Deepvine installs private AI knowledge systems for law firms, RIAs, CPA firms, and other knowledge-driven businesses: connected to your systems, backfilled with your history, deployed in your environment, and owned by you.',
  },
  {
    name: 'Adam Kerr',
    role: 'Co-founder',
